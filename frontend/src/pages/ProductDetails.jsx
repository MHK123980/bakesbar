...
export default function ProductDetails() {
  ...
  const fetchProductAndConfig = async () => {
    try {
      ...
      const cachedProducts = JSON.parse(localStorage.getItem('bakesbar_products')) || [];
      ...
      if (configRes.data && !configRes.data.includes?.('<!DOCTYPE html>')) {
        ...
        localStorage.setItem('bakesbar_config', JSON.stringify(configRes.data));
      }
      
      if (Array.isArray(productRes.data)) {
        localStorage.setItem('bakesbar_products', JSON.stringify(productRes.data));
  ...
  return (
    <div className="product-page-container">
      ...
      <header className="page-header">
        <h1 className="header-title">BAKESBAR</h1>
      </header>
