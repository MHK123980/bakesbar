...
export default function Admin() {
  ...
  const generateMonthlyReport = async () => {
    ...
    try {
      ...
      // Header
      doc.setFontSize(22);
      doc.setTextColor(139, 28, 49); // brand color
      doc.text("BakesBar", 14, 20);
      ...
      autoTable(doc, {
        ...
        theme: 'striped',
        headStyles: { fillColor: [139, 28, 49] }
      });
      ...
      doc.save(`BakesBar_Report_${data.monthName.replace(' ', '_')}.pdf`);
  ...
  return (
    <>
      ...
      <div className="mobile-header">
        ...
        <h2 className="mobile-brand">BAKESBAR</h2>
      </div>
      ...
      <div className="admin-content">
          ...
          <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
            <div className="dashboard-header-row">
              <div>
                ...
                <p style={{color: '#4A0E1A', opacity: 0.8, fontSize: '0.95rem'}}>Real-time sales insights and performance metrics</p>
              </div>
              <div style={{display: 'flex', gap: '10px', alignItems: 'center', flexWrap: 'wrap'}}>
                <div style={{ display: 'flex', gap: '6px', alignItems: 'center', flexWrap: 'wrap' }}>
                  ...
                  <button className="btn-small" onClick={generateMonthlyReport} style={{display: 'flex', alignItems: 'center', gap: '5px', height: 'fit-content', backgroundColor: '#8B1C31', color: 'white'}}>
                    📄 Generate Data Sheet
                  </button>
                </div>
              ...
              <>
                ...
                <div className="dashboard-charts-grid">
                  ...
                  <div className="chart-card glass-panel">
                    ...
                    <p style={{fontSize: '0.85rem', color: '#4A0E1A', opacity: 0.8, marginBottom: '20px'}}>Excluding cancelled orders</p>
                  ...
                  <div className="top-products-card glass-panel">
                    ...
                    <p style={{fontSize: '0.85rem', color: '#4A0E1A', opacity: 0.8, marginBottom: '20px'}}>Ranked by quantity sold</p>
                    
                    <div className="top-products-list">
                      {analytics.topProducts.length === 0 ? (
                        <p style={{textAlign: 'center', color: '#4A0E1A', opacity: 0.6, marginTop: '40px'}}>No cookie sales data yet.</p>
                      ) : (
        ...
        {activeTab === 'orders' && !viewingOrder && !isAddOrderOpen && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <div className="dashboard-header-row">
              ...
              <button className="btn-small" onClick={() => setIsAddOrderOpen(true)} style={{backgroundColor: '#8B1C31', color: 'white'}}>+ Add Order</button>
            </div>
            ...
            <div className="glass-panel">
              ...
              <div className="management-grid" style={{gridTemplateColumns: '1fr 1fr'}}>
                ...
                <div className="form-group" style={{borderLeft: '1px solid rgba(0,0,0,0.1)', paddingLeft: '20px'}}>
                  ...
                  <button className="btn" onClick={handleManualOrderSubmit} style={{width: '100%', marginTop: '20px', backgroundColor: '#8B1C31', color: 'white', padding: '12px'}}>Place Order</button>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <footer style={{textAlign: 'center', marginTop: '50px', paddingBottom: '20px', color: '#555'}}>
          <p style={{fontSize: '1.1rem', fontWeight: 800}}>© 2026 BakesBar All rights reserved By MHK</p>
        </footer>
      </div>
      ...
      {viewingOrder && (
        <div className="print-only">
          <div className="thermal-receipt">
            <h1 className="receipt-title">BAKESBAR</h1>
            ...
            <div style={{textAlign: 'center', fontSize: '8px', marginTop: '10px', color: 'black'}}>
              © 2026 BakesBar All rights reserved By MHK
            </div>
          </div>
        </div>
      )}
